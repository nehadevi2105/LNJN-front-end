...
const Approvebanner = () => {
    ...
    const [formData, setFormData] = useState({
        content: "",
        imgsrc: null,
        imgpath: "", // Stores the existing image path
    });
        ...
        <div>
            <form>
                <Paper elevation={15} sx={{ padding: 8, maxWidth: "1200px", margin: "auto", position: "relative" }}>
                    <h1>{id ? "Update Banner" : "Upload Banner"}</h1>
                    ...
                    <input type="file" onChange={handleImageChange} style={{ display: "none" }} id="upload-input" />
